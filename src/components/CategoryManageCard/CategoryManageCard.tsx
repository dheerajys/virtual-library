/**
 * Category card with manage mode actions (edit/delete)
 * Simplified version without icon dependencies
 */
...
const CategoryManageCard: React.FC<CategoryManageCardProps> = ({
  category,
  onClick,
  isSelected = false,
  onDelete,
...
export default CategoryManageCard;
